...
data class InboxResponseModel(val conversationId: String = "", val user1Email: String = "", val user2EMail: String = "", val user1ImageUrl: String = "", val user2ImageUrl: String = "", val user1Name: String = "", val user2Name: String = "", var lastMsg: String = "", var lastMsgTime: String = "") : Serializable
data class DialogItems(val title: String = "", val description: String = "", val buttonPositive: String = "", val buttonNegative: String = "")