...
{
    class ConversationViewHolder(val binding: AdapterRecentConversationBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    {
        return ConversationViewHolder(AdapterRecentConversationBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
